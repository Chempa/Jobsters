...
class T_VIEW_EXPORT jobs_indexView : public TActionView
{
  Q_OBJECT
public:
  Q_INVOKABLE
  jobs_indexView() : TActionView() { }
  jobs_indexView(const jobs_indexView &) : TActionView() { }
  QString toString();
};

QString jobs_indexView::toString()
{
  responsebody.reserve(5809);
...
Q_DECLARE_METATYPE(jobs_indexView)
T_REGISTER_VIEW(jobs_indexView)

#include "jobs_indexView.moc"
