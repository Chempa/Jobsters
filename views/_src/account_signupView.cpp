...
class T_VIEW_EXPORT account_signupView : public TActionView
{
  Q_OBJECT
public:
  Q_INVOKABLE
  account_signupView() : TActionView() { }
  account_signupView(const account_signupView &) : TActionView() { }
  QString toString();
};

QString account_signupView::toString()
{
  responsebody.reserve(5444);
